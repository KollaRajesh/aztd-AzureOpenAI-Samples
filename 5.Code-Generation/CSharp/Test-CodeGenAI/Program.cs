...
do {
    ...
    switch (command) {
        case "1":
            string functionFile = System.IO.File.ReadAllText("../../Sample-code/function/AbsoluteSquare.cs");
            ...
            break;
        case "2":
            functionFile = System.IO.File.ReadAllText("../../Sample-code/function/AbsoluteSquare.cs");
            string unitTestPrompt = "Write four unit tests for the following function.\n---\n" + functionFile;
            
            await GetResponseFromOpenAI(unitTestPrompt);
            break;
        case "3":
            string goFishFile = System.IO.File.ReadAllText("../../Sample-code/go-fish/Program.cs");
